...
class XML_Viwer(Frame):
    ...
    def __init__(self, master, xml=None, width=None , height=None ,  padding=None, cursor=None,  style = None):
...
#                 self._treeview.heading("#0", text=heading_text)
        ...
        self._treeview.column("#0", minwidth=2500, stretch= True) #minwidth=2500, 
        ...
        self._vsb.grid(column=1, row=0, sticky=N+S+W+E) #N+S
        self._hsb.grid(column=0, row=1, sticky=W+E+N+S) #E+W
# #         
